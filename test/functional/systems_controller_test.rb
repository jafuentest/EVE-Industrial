...
class SystemsControllerTest < ActionController::TestCase
  ...
  test "should create system" do
    assert_difference('System.count') do
      post :create, system: { central_id: @system.central_id, name: @system.name, region_id: @system.region_id }
    end
  ...
  test "should update system" do
    put :update, id: @system, system: { central_id: @system.central_id, name: @system.name, region_id: @system.region_id }
    assert_redirected_to system_path(assigns(:system))
  end
